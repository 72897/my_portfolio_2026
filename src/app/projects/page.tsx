                    ...
                    <Depth3DCard depthStrength={12} className="h-full">
                      ...
                      >
                        ...
                        <div className="p-3 sm:p-4">
                          ...
                          {project.metrics && (
                            <DepthLayer z={40} className="mt-4 grid grid-cols-3 gap-1.5 border-t border-border/30 pt-3">
                          ...
                          {/* Tech */}
                          <DepthLayer z={35} className="mt-4 flex flex-wrap gap-1">
                          ...
                          {/* Links */}
                          <DepthLayer z={50} className="mt-4 pt-3 border-t border-border/40 flex items-center justify-between gap-2">
